    ...
    return (
      <div className="flex flex-col gap-4 p-4 bg-blue-50 border border-blue-200">
        <div className="flex items-center justify-center gap-4">
          <input 
            type="number" 
            className="bg-neutral-50 w-12 appearance-none border border-neutral-500 rounded text-center"
          ...
          <input 
            type="number" 
            className="bg-neutral-50 w-12 border border-neutral-500 rounded text-center"
        ...
        <div className="flex gap-2 justify-center">
          <input 
            type="date" 
            className="bg-neutral-50 text-xs border border-neutral-500 rounded p-1"
            value={formData.date}
    ...
    <div className={`relative flex items-center justify-between p-4 sm:p-8 border first:rounded-t-sm last:rounded-b-sm transition-all ${
      ...
      <div className="flex flex-col items-center px-1 sm:px-4 min-w-[100px]">
        {isFinished ? (
          ...
          <p className="bg-neutral-300 text-xs font-medium text-neutral-700 uppercase px-2 py-1 rounded-xs ">
            {match.time ? match.time : "Agendada"}
          </p>
        )}
        <span className="text-xs font-medium text-neutral-400 uppercase mt-1">
